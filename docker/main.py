...
from flask import session, redirect, url_for, request, Response, send_from_directory
import socket
...
ipaddr = os.environ['ORACLE_HOST']
# dsn = os.environ['ORACLE_DSN']
# dsn = user + "/" + password + "@//localhost/XEPDB1"
dsn = """
    (DESCRIPTION_LIST =
    (DESCRIPTION =
      (ADDRESS = (PROTOCOL = TCP)(HOST = 172.20.0.3)(PORT = 1521))
    )
  )
  """
...
def authenticate():
    """Autentificare de baza pentru a accesa pagina"""
    return Response('Nu ai introdus adte de autentificare corecte pentru aceasta pagina.\n'
                    'Trebuie sa te autentifici cu credentiale valide', 401,
