...
CREATE TABLE COSTI_Prezenta (
    ...
    attendance_status VARCHAR2(50) CHECK (attendance_status IN ('Prezent', 'Absent')), -- verificare constraint. Valorile din attendance_status pot fi doar Absent sau Prezent
    FOREIGN KEY (emp_id) REFERENCES COSTI_Angajati(emp_id)                             -- cheie externa care face referire la tabela angajatilor
);



-- Introducere date in tabele
...
-- Insert into COSTI_Prezenta Table
...
-- Introducere noi date in tabele
